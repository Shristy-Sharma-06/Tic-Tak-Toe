function myfunction(){
    ...
    //game tie
        ...
        .innerHTML="game is  tie";
        
    }


    // else if( (b1,b2,b3,b4,b5,b6,b7,b8,b9 == 'x') || (b1,b2,b3,b4,b5,b6,b7,b8,b9 == '0')) {
    //     document.getElementById("print").innerHTML="game is  tie";
        
    // }
    // printing result
    else{
       if(flag == 1){
        document.getElementById('print').innerHTML='player X turn on';
       }

       else{
        document.getElementById('print').innerHTML='player 0 turn on';
       }
